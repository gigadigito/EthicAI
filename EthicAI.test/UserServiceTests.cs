...
//            // Mock para o IConfiguration (simulação de configuração)
//            _mockConfiguration = new Mock<IConfiguration>();

//            // Instância do UserService com o mock de IConfiguration
//            _userService = new UserService(_mockConfiguration.Object); // Corrigido para passar IConfiguration ao invés de DbContextOptions
