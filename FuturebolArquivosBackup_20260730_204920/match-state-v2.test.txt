...
assert.ok(minimumPlayerSeparation >= 1.31, `jogadores não devem se sobrepor durante a jogada: ${minimumPlayerSeparation}`);
...
console.log("Futurebol match state V2 tests passed");
