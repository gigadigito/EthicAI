...
public partial class FuturebolLab
{
    ...
    protected override async Task OnParametersSetAsync()
    {
        ...
        await LoadRouteMarketDataAsync();
    ...
    private async Task InitializeAsync()
    {
        ...
        try
        {
            ...
            /*
             * A primeira execução usa High. Nas próximas visitas, o módulo
             * restaura apenas uma escolha feita explicitamente pelo usuário.
             */
            var preferredQuality = await _module.InvokeAsync<string>(
                "getPreferredQuality",
                DefaultQuality);
            _quality = NormalizeQuality(preferredQuality);
            await InvokeAsync(StateHasChanged);
    ...
    private async Task LoadRouteMarketDataAsync()
    {
        _match = null;
    ...
    {
        _quality = NormalizeQuality(quality);
