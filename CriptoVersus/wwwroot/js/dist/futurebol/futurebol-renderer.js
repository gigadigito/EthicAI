...
export class FuturebolRenderer {
    constructor(B, canvas, teams, development, quality, reducedMotion) {
        ...
        this.bubbleWarningLogged = false;
    ...
    updateMarketBubble(players, ballOwnerId, homeAsset, awayAsset, deltaSeconds) {
        ...
        try {
            ...
            this.marketBubble.update({ ownerPlayerId: null, ownerTeam: null, asset: null, headScreenX: 0, headScreenY: 0, visible: false }, 0, 0, deltaSeconds, 0, 0);
        }
    }
