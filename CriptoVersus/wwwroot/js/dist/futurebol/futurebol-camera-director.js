...
export class FuturebolCameraDirector {
    ...
    broadcastTargets(ctx, direction) {
    ...
    buildUpTargets(ctx, direction, velocityLead, lateralLead) {
        return {
    ...
    attackTargets(ctx, direction, velocityLead, lateralLead) {
        return {
            positionX: clamp(ctx.ballPosition.x * 0.58 + direction * ATTACK_LEAD_FACTOR + velocityLead, -14.2, 14.2),
            positionY: 19.1,
            positionZ: -28.1,
    ...
    shotPrepTargets(ctx, direction, velocityLead, lateralLead) {
        ...
        return {
            positionX: clamp(ctx.ballPosition.x * 0.7 + direction * 3.4 + velocityLead, -15.2, 15.2),
    ...
    shotTrackingTargets(ctx, direction, velocityLead, lateralLead) {
        ...
        return {
            positionX: clamp(ctx.ballPosition.x * 0.65 + direction * 2.8 + ballLead, -16, 16),
    ...
    goalCelebrationTargets(ctx, direction) {
