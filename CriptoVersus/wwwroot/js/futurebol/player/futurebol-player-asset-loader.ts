...
function readAssetResourceTiming(): PerformanceResourceTiming | null {
    const assetUrl = new URL(
        `${FUTUREBOL_PLAYER_ASSET.rootUrl}${FUTUREBOL_PLAYER_ASSET.fileName}`,
        document.baseURI
    ).href;
    const entries = performance.getEntriesByName(assetUrl, "resource") as PerformanceResourceTiming[];
