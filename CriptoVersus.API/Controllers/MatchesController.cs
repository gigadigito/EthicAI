...
namespace CriptoVersus.API.Controllers
{
    ...
    public class MatchesController : ControllerBase
    {
        ...
        // Retorna o match Ongoing do par, sen�o o mais recente
        // =========================
        [AllowAnonymous]
        [HttpGet("by-symbols")]
            ...
            CancellationToken ct = default)
        {
            if (string.IsNullOrWhiteSpace(symbolA) || string.IsNullOrWhiteSpace(symbolB))
                return BadRequest("symbolA e symbolB s�o obrigat�rios.");
            ...
            CancellationToken ct)
        {
            ...
            if (teamA is null || teamB is null)
                return BadRequest("Time inv�lido.");
        ...
        public async Task<ActionResult> Start(int id, CancellationToken ct)
        {
            ...
            if (match.Status != MatchStatus.Pending)
                return BadRequest("A partida n�o est� pendente.");
        ...
        public async Task<ActionResult> Complete(int id, CancellationToken ct)
        {
            ...
            if (match.Status != MatchStatus.Ongoing)
                return BadRequest("A partida n�o est� em andamento.");
